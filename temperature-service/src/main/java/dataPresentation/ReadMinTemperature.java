...
public class ReadMinTemperature implements ReadTemperature {
    ...
    public List<String> readAllData(String from, String to) throws SQLException {
        ...
        String sql = "SELECT * FROM minWeather";
    ...
    public void recordToList(Gson gson, ResultSet rs, List<String> records) throws SQLException {
        ...
        double minValue = rs.getDouble("minValue");

        NewWeather minWeather = new NewWeather(date, time, place, station, minValue);
        String print = gson.toJson(minWeather);
        records.add(print);
    }
